...
assert_file "$OUT/local-server/Dockerfile"
...
assert_file "$OUT/local-server/src/main/java/com/valkyrlabs/graymatter/localserver/bootstrap/StarterKnowledgePackBootstrap.java"
assert_file "$OUT/local-server/src/main/java/com/valkyrlabs/graymatter/localserver/service/KnowledgePackArchiveWriter.java"
assert_file "$OUT/local-server/src/main/java/com/valkyrlabs/graymatter/localserver/service/KnowledgePackExportService.java"
...
assert_file "$OUT/local-server/src/main/resources/knowledgepacks/graymatter-lite-starter.json"
...
assert_contains "/v1/graymatter/stats" "$OUT/api.hbs.yaml"
assert_contains "/v1/graymatter/stats" "$OUT/api.yaml"
assert_contains "/v1/Workbook" "$OUT/api.hbs.yaml"
assert_contains "Principal" "$OUT/api.hbs.yaml"
assert_contains "MemoryEntry" "$OUT/api.hbs.yaml"
assert_contains "/v1/MemoryEntry/{id}" "$OUT/api.hbs.yaml"
assert_contains "/v1/MemoryEntry/query" "$OUT/api.hbs.yaml"
assert_contains "/v1/MemoryEntry/write" "$OUT/api.hbs.yaml"
assert_contains "/v1/swarm-ops/graph" "$OUT/api.hbs.yaml"
assert_contains "/v1/knowledge-packs/export" "$OUT/api.hbs.yaml"
assert_contains "x-graymatter-mcp-contract" "$OUT/api.hbs.yaml"
assert_contains "memory_put" "$OUT/api.hbs.yaml"
assert_contains "memory_get" "$OUT/api.hbs.yaml"
assert_contains "memory_query" "$OUT/api.hbs.yaml"
assert_contains "memory_health" "$OUT/api.hbs.yaml"
assert_contains "production api-0 path subset" "$OUT/api.hbs.yaml"
...
assert_contains "/v1/MemoryEntry/query" "$OUT/application-bundle/openapi.json"
assert_contains "/v1/swarm-ops/graph" "$OUT/application-bundle/openapi.json"
assert_contains "/v1/knowledge-packs/export" "$OUT/application-bundle/openapi.json"
...
assert_contains "/v1/MemoryEntry" "$OUT/dashboard/index.html"
assert_contains "/v1/Workbook" "$OUT/api.hbs.yaml"
assert_contains '"generationMode": "thorapi-febe"' "$OUT/local-server/manifest.json"
assert_contains '"artifactId": "graymatter-lite"' "$OUT/local-server/manifest.json"
assert_contains '"license": "AGPL-3.0-only"' "$OUT/local-server/manifest.json"
...
assert_contains "/v1/graymatter/activation/bridge/event" "$OUT/application-bundle/openapi.json"
assert_contains "/v1/swarm-ops/graph" "$OUT/application-bundle/openapi.json"
assert_contains "/v1/memory/status" "$OUT/application-bundle/openapi.json"
assert_contains "/v1/Workbook" "$OUT/application-bundle/openapi.json"
assert_contains "/v1/api-docs" "$OUT/local-server/src/main/resources/openapi.json"
assert_contains "/v1/knowledge-packs/export" "$OUT/local-server/src/main/resources/openapi.json"
...
assert_contains "/v1/memory/status" "$OUT/local-server/src/main/resources/static/index.html"
...
assert_contains "GrayMatter Lite Local Server" "$OUT/local-server/README.md"
assert_contains "ValkyrSWARM" "$OUT/local-server/src/main/resources/knowledgepacks/graymatter-lite-starter.json"
...
assert_contains "/v1/knowledge-packs/export" "$PLUGIN_OUT/api.hbs.yaml"
