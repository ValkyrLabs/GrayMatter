...
jq -e '.tools | map(.name) | sort == ["memory_get","memory_health","memory_link","memory_put","memory_put_batch","memory_query","memory_replay_deferred","memory_retrieve_with_receipt","omega_forget","omega_recall","omega_remember","retrieval_receipt_get","retrieval_receipt_query"]' "$contract" >/dev/null
